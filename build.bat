...
:installdeps
	...
	cd .deps || goto :error
	call :download go.zip https://download.wireguard.com/windows-toolchain/distfiles/go1.16rc1-2021-02-10.zip ec9135d3c55c1ba7a1c92ea9e2b6a58d47fd948919cc3aaf3f5fdac908a87805 || goto :error
